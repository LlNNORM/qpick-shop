...
import type { Product, BasketItemQuantity } from '../../types'

type BasketListItemProps = Product & {
  quantity: BasketItemQuantity
}

const BasketListItem = ({ img, title, price, id, quantity }: BasketListItemProps) => {
    ...
    return (
        <div className="basket__item">
            ...
            <div className="basket__item-extra">
                ...
                <div className="basket__item-totalPrice">{`${price} ₽`}</div>
            </div>
        </div>
    )
}
